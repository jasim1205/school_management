    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="bs-stepper-content">
                <form class="form" method="post"action="{{route('session.store')}}">
                                @csrf
                    <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                <label class="col-sm-3 col-form-label"><strong>Session Year (English) </strong><i class="text-danger">*</i></label>
                                <input type="text" id="" class="form-control shadow-lg" value="{{ old('session_year_en')}}" name="session_year_en" placeholder="Session Year (English)">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="" class="form-control shadow-lg" value="{{ old('session_year_bn')}}" name="session_year_bn" placeholder="Session Year (Bangla)">
