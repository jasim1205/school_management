...
@section('title','Add Designations')
    ...
    <div class="card">
        <div class="card-body">
            <div class="bs-stepper-content">
                <form class="form" method="post"action="{{route('designation.store')}}">
                                @csrf
                    <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="designation_name" class="form-control" value="{{ old('designation_name')}}" name="designation_name" Required placeholder="Input Designation Name">
