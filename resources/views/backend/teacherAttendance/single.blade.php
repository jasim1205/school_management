    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="bs-stepper-content">
                 <form class="form" method="post"action="{{route('update',encryptor('encrypt',$attend->id))}}">
                                @csrf
                    <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                <label for=""><strong>Teacher Name</strong><i class="text-danger">*</i> </label>
                                            
                                <input type="text" id="" class="form-control" value="{{ old('teacher_id',$attend->teacher?->first_name_en)}}  {{ $attend->teacher?->last_name_en }}" name="teacher_id" readonly>
