...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
             <a href="{{route('period.create')}}" class="btn btn-primary"><i class="fa fa-plus">ADD NEW</i></a>
        </div>
    </div>
    <!--end breadcrumb-->
                ...
                <table id="example2" class="table table-striped table-bordered">
                    ...
                    @forelse($period as $p) 
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{route('period.edit',encryptor('encrypt',$p->id))}}" class=""><i class="fas fa-edit"></i>
                                </a>
