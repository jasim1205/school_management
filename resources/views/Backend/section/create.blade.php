                    ...
                    <p class="mb-4">Enter your personal information to get closer to copanies</p>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="section_name_en" class="form-control" value="{{ old('section_name_en')}}" name="section_name_en" placeholder="Section Name English">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="section_name_bn" class="form-control" value="{{ old('section_name_bn')}}" name="section_name_bn" placeholder="Section Name Bangla">
