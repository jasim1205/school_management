...
<a href="{{route('section.create')}}" class="btn btn-lg py-3 btn-primary"><i class="fa fa-plus">ADD NEW</i></a>
<hr/>
<div class="card">
    <div class="card-body">
                ...
                <tbody>
                    @forelse($section as $value)
                        <tr>
                            ...
                            <td>
                                    <div class="d-flex">
                                    <a href="{{route('section.edit',encryptor('encrypt',$value->id))}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <form id=""
