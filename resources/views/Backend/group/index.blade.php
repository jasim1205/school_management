...
<a href="{{route('group.create')}}" class="btn btn-lg py-3 btn-primary"><i class="fa fa-plus">ADD NEW</i></a>
<hr/>
<div class="card">
    <div class="card-body">
                ...
                <tbody>
                    @forelse($group as $g) 
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{route('group.edit',encryptor('encrypt',$g->id))}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i>
                                </a>
