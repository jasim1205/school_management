        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('school.update',encryptor('encrypt',$school->id))}}">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="" class="form-control shadow-sm" value="{{ old('school_id_en',$school->school_id_en)}}" name="school_id_en" Required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="" class="form-control shadow-sm" value="{{ old('school_title_en',$school->school_title_en)}}" name="school_title_en">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="" class="form-control shadow-sm" value="{{ old('school_address_en',$school->school_address_en)}}" name="school_address_en" placeholder="" Required>
                                ...
                                <div class="form-group mb-3">
                                    <label for="status">EIIN No (English) </label>
                                     <input type="text" id="" class="form-control shadow-sm" value="{{ old('eiin_no_en',$school->eiin_no_en)}}" name="eiin_no_en" placeholder="" Required>
                            ...
                            <div class="col-xl-6 mt-1">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="" class="form-control shadow-sm" value="{{ old('school_name_en',$school->school_name_en)}}" name="school_name_en" Required>
                                ...
                                <div class="form-group mb-3">
                                    <label for="">Email Address</label>
                                     <input type="text" id="" class="form-control shadow-sm" value="{{ old('email',$school->email)}}" name="email" placeholder="" Required>
                                            @if($errors->has('email'))
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="" class="form-control shadow-sm" value="{{ old('web_address',$school->web_address)}}" name="web_address">
