                    ...
                    <p class="mb-4">Enter your personal information to get closer to copanies</p>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="class_name_en" class="form-control shadow-lg" value="{{ old('period_name',$period->period_name)}}" name="period_name" placeholder="">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" id="duration" class="form-control shadow-lg" value="{{ old('duration',$period->duration)}}" name="duration" placeholder="Class Name Bangla">
