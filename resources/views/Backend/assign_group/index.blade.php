                    ...
                    <p class="mb-4">Enter your personal information to get closer to copanies</p>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                ...
                                <div>
                                    <label for="">
                                        <input @if(in_array($g->id,$classGroup)) checked @endif type="checkbox" value="{{$g->id}}" name="group_id[]" id="" class="mx-2">{{$g->group_name_en}}
                                    </label>
                                </div>
                                @endforeach
                            </div>
...
<script>
    function change_location(class_id){
        location.href="{{route('assigngroup.index')}}?class_id="+class_id
    }
</script>
@endpush